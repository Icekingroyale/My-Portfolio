...
const Projects = ({ }) => {
  ...
  return (
    <div className="bg-[#71BBB2] bg-[url('https://www.transparenttextures.com/patterns/crosswordz.png')] min-h-screen text-center place-content-center place-items-center">
