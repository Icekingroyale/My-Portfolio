    ...
    return (
        <div className="bg-[#EFE9D5] bg-[url('https://www.transparenttextures.com/patterns/brushed-alum-dark.png')] w-screen h-screen content-center md:hidden overflow-y-hidden" >
            ...
            <div className='flex text-2xl font-semibold'>
                ...
                <NavLink to="/contact" className="px-3 py-2 mx-auto bg-green-500 border-2 border-gray-600 rounded-md hover:bg-green-800 hover:text-white " onClick={onLinkClick}>
                    Contact Me
                </NavLink>
